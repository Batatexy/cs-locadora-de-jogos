...
namespace LocadoraDejogos.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,CPF,Nome,DataNascimento")] Funcionarios funcionarios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,CPF,Nome,DataNascimento")] Funcionarios funcionarios)
        {
